<footer>
    <div class="reseaux">
        <div class="adresse">
            <h2> {{GoogleTranslate::trans('ADRESSE', app()->getLocale())}}</h2>
        ...
        <div class="icone_contact">
            <h2> {{GoogleTranslate::trans('RESEAUX SOCIAUX', app()->getLocale())}}</h2>
            <div class="icone">
                <a href="#">
        ...
        <form class="form_contact" method="post" action="{{ route('newslatter')}}">
            ...
            @csrf
            <h2> {{GoogleTranslate::trans('Abonez-vous à notre newletter', app()->getLocale())}}</h2>
