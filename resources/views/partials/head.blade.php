<head>
    ...
    <title>ONG ACID - Dashboard</title>
    <!-- Photo du title -->
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('images/acid.jpeg')}}" />
    <!-- Custom fonts for this template-->
    <link href="{{ asset('pluggins/fontawesome-free/css/all.min.css')}}" rel="stylesheet" type="text/css">
