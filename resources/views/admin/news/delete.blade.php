...
<div class="modal fade" id="modalDelete{{ $new->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        {{ GoogleTranslate::trans("Comfirmez la suppression de la publication ", app()->getLocale()) }}<strong>{{ GoogleTranslate::trans($new->title, app()->getLocale()) }}</strong>
      </div>
