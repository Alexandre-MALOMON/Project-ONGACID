            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{ GoogleTranslate::trans($categorie->name, app()->getLocale()) }}" name="name" id="inputEmail4" >
                        @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="editor" name="description" cols="30" rows="10">{{ GoogleTranslate::trans($categorie->description?   $categorie->description :"Pas de description", app()->getLocale()) }}</textarea>
                        @error('description')
                        <span class="text-danger">{{ GoogleTranslate::trans($message, app()->getLocale()) }}</span>
                        @enderror
                    </div>
