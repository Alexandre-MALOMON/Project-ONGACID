<form  action="{{route('categoriactualite.destroy', $categorie->id)}}" method="POST">
@csrf
@method('DELETE')

<div class="modal fade" id="modalDelete{{ $categorie->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        Comfirmez la suppression de la catégorie <strong>{{$categorie->name}} {{$categorie->prenom}}</strong>
      </div>
