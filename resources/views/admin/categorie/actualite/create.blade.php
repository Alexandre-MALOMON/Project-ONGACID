<form action="{{route('categoriactualite.store')}}" method="POST">
    @csrf
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">{{ GoogleTranslate::trans("Nouvelle catégorie", app()->getLocale()) }}</h5>
