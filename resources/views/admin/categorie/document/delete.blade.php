...
<div class="modal fade" id="modalDelete{{ $document->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      {{ GoogleTranslate::trans("Comfirmez la suppression de la catégorie", app()->getLocale()) }} <strong>{{ GoogleTranslate::trans($document->name, app()->getLocale()) }} </strong>
      </div>
