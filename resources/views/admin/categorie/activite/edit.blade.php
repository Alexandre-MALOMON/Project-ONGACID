            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{ $activite->name }}" name="name" id="inputEmail4" >
                        @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="editor" name="description" cols="30" rows="10">{{ $activite->description?   $activite->description :"Pas de description"}}</textarea>
                        @error('description')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
