<form action="{{ route('courscategory.update',$courCategory->id)}}" method="POST">
    @csrf
    @method('put')
    <div class="modal fade" id="modalEdit{{$courCategory->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
